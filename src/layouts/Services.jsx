    ...
    <section className="bg-white lg:mt-5">
      <div className="container px-6 py-10 mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 gap-8 lg:gap-12 md:grid-cols-2 xl:grid-cols-3 mt-8 lg:mt-12">
            {servicesData.map((service) => (
              <div key={service.id}>
                ...
                <div className="mt-8">
                  <span className="text-blue-500 uppercase font-medium">
                    {service.category}
                  </span>
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <div>
                      <a
                        href="#"
                        className="text-lg lg:text-xl font-medium text-gray-700 hover:underline hover:text-gray-500"
                      >
                        {service.price}
                      </a>
                    </div>
